...
// - 포장 객체는 포장하고 있는 기본 타입의 값을 변경할 수 없고, 단지 객체로 셍성하는데 목적이 있음
// - 컬렉션 객체 때문, 기본 타입의 값은 저장할 수 없고, 객체만 저장 가능하기 때문 => 이 때 Wrapper 객체를 사용하면 된다.
...
public class BoxingUnboxing {
    public static void main(String[] args) {
        ...
        Integer obj1 = 100; // Integer 에 int 값을 넣음, 자동으로 auto-boxing
        Double obj2 = 3.14;
        Character obj3 = 'A';
